...
def import_all_data(df):
    # 1. پیدا کردن یا ساختن گروه لپ‌تاپ
    try:
        product_group = ProductGroup.objects.get(group_title=PRODUCT_GROUP_NAME)
    except ProductGroup.DoesNotExist:
        print(f"❌ گروه کالا با عنوان '{PRODUCT_GROUP_NAME}' پیدا نشد.")
        return
    ...
    for _, row in df.iterrows():
        ...
        for feature_name in feature_columns:
            ...
            try:
                ...
                print(f"⚠️ Feature '{feature_name}' not found.")

    print("✅ وارد کردن اطلاعات با موفقیت انجام شد.")
