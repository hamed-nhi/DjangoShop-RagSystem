# Generated by Django 5.0.14 on 2025-05-12 08:16
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "brand_title",
                    models.CharField(max_length=100, verbose_name="نام برند"),
                ),
                (
                    "image_name",
                    models.ImageField(
                        upload_to=utils.FileUpload.upload_to,
                        verbose_name="تصویر برند کالا",
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "feature_name",
                    models.CharField(max_length=200, verbose_name="نام ویژگی"),
                ),
            ],
            options={
                "verbose_name": "ویژگی",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "product_name",
                    models.CharField(max_length=550, verbose_name="نام کالا"),
                ),
                (
                    "description",
                    models.TextField(
                ...
                (
                    "update_date",
                    models.DateTimeField(
                        auto_now=True, verbose_name="تاریخ آخرین بروز رسانی"
                    ),
                ),
                (
                    "brand",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "group_title",
                    models.CharField(max_length=100, verbose_name="عنوان گروه کالا"),
                ),
                (
                    "image_name",
                    models.ImageField(
                ...
                (
                    "description",
                    models.TextField(
                        blank=True, null=True, verbose_name="توضیحات گروه کالا"
                    ),
                ),
                (
                    "is_active",
